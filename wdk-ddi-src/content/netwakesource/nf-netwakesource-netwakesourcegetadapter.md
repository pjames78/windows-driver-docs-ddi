...
Client drivers that have one network adapter per device do not need to call this optional function. Call **NetWakeSourceGetAdapter** if your device has more than one net adapter object per device, such as in a [MBBCx client driver](/windows-hardware/drivers/netcx/mobile-broadband-mbb-wdf-class-extension-mbbcx).
