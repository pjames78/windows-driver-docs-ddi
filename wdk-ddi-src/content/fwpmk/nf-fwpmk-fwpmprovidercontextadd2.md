...
ms.date: 06/12/2024
targetos: Windows
description: The FwpmProviderContextAdd2 function adds a new provider context to the system.
prerelease: false
req.assembly: 
...
Some fields in the [FWPM_PROVIDER_CONTEXT2](/windows/desktop/api/fwpmtypes/ns-fwpmtypes-fwpm_provider_context2) structure are assigned by the system, not the caller, and are ignored in the call to **FwpmProviderContextAdd2**.
