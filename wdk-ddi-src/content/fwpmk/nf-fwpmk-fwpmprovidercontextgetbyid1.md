...
ms.date: 06/13/2024
targetos: Windows
description: The FwpmProviderContextGetById1 function retrieves a provider context.
prerelease: false
req.assembly: 
...
A run-time identifier for the desired object. This must be the run-time identifier that was received from the system when the application called **[FwpmProviderContextAdd1](nf-fwpmk-fwpmprovidercontextadd1.md)** for this object.
