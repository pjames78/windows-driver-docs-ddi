...
The driver received an 
      <a href="/windows-hardware/drivers/network/oid-pnp-set-power">OID_PNP_SET_POWER</a> notification that
...
After NDIS calls the 
    ...
    calls the driver's 
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_halt">MiniportHaltEx</a> function. If the driver
