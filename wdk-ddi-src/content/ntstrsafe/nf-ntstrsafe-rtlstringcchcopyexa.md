...
title: RtlStringCchCopyExA function (ntstrsafe.h)
  ...
  <tr>
    ...
    <td>
      ...
      <ul>
        ...
        <li>A **NULL** pointer was present without the <b>STRSAFE_IGNORE_NULLS</b> flag.</li>
        <li>The destination buffer pointer was **NULL**, but the buffer size was not zero.</li>
        <li>The destination buffer pointer was **NULL**, or its length was zero, but a nonzero length source string was
          present.</li>
      </ul>
    </td>
  </tr>
