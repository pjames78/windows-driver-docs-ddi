...
The **RtlUnicodeStringCchCopyStringNEx** function copies a string into a [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure while limiting the size of the copied string.
...
**RtlUnicodeStringCchCopyStringNEx** adds to the functionality of the [RtlUnicodeStringCchCopyStringN](./nf-ntstrsafe-rtlunicodestringcchcopystringn.md) function by returning a [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure that identifies the end of the destination string and the number of bytes that are left unused in that string. You can pass flags to **RtlUnicodeStringCchCopyStringNEx** for additional control.
...
- [RtlUnicodeStringCbCopyStringNEx](./nf-ntstrsafe-rtlunicodestringcbcopystringnex.md)
- [RtlUnicodeStringCchCopyStringN](./nf-ntstrsafe-rtlunicodestringcchcopystringn.md)
