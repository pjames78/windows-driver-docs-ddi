...
title: RtlStringCchVPrintfExW function (ntstrsafe.h)
description: Learn how the RtlStringCchVPrintfExW and RtlStringCchVPrintfExA functions create a character-counted text string, with formatting that is based on supplied formatting information.
...
<td width="60%">
If set, <i>pszDest</i> can be <b>NULL</b>. <b>NULL</b> <i>pszDest</i> pointers cannot receive nonempty strings. 
...
<i>pszDest</i> cannot be <b>NULL</b> unless the STRSAFE_IGNORE_NULLS flag is set.
...
<a href="/windows-hardware/drivers/ddi/ntstrsafe/nf-ntstrsafe-rtlstringcbvprintfexa">RtlStringCbVPrintfEx</a>
