...
The **NET_ADAPTER_WAKE_PACKET_FILTER_CAPABILITIES_INIT** function initializes a [**NET_ADAPTER_WAKE_PACKET_FILTER_CAPABILITIES**](../netadapter/ns-netadapter-_net_adapter_wake_packet_filter_capabilities.md) structure.
