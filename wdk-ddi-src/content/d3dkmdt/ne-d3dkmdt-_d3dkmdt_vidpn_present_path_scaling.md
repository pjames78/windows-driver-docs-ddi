...
f1_keywords:
 ...
 - d3dkmdt/_D3DKMDT_VIDPN_PRESENT_PATH_SCALING
 - D3DKMDT_VIDPN_PRESENT_PATH_SCALING
 - d3dkmdt/D3DKMDT_VIDPN_PRESENT_PATH_SCALING
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>Scaling</b> member of the <a href="/windows-hardware/drivers/ddi/d3dkmdt/ns-d3dkmdt-_d3dkmdt_vidpn_present_path_transformation">D3DKMDT_VIDPN_PRESENT_PATH_TRANSFORMATION</a> structure is a value from the D3DKMDT_VIDPN_PRESENT_PATH_SCALING enumeration.
