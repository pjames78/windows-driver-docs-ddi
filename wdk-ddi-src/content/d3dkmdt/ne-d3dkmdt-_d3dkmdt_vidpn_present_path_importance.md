...
f1_keywords:
 ...
 - d3dkmdt/_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE
 - D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE
 - d3dkmdt/D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>ImportanceOrdinal</b> member of the <a href="/windows-hardware/drivers/ddi/d3dkmdt/ns-d3dkmdt-_d3dkmdt_vidpn_present_path">D3DKMDT_VIDPN_PRESENT_PATH</a> structure is a D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE value. Path importance ordinal numbers are unique within a given VidPN topology.
