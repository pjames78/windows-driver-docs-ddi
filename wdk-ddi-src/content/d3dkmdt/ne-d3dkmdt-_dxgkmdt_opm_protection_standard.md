...
tech.root: display
ms.date: 05/10/2018
keywords: ["DXGKMDT_OPM_PROTECTION_STANDARD enumeration"]
...
f1_keywords:
 - _DXGKMDT_OPM_PROTECTION_STANDARD
 - d3dkmdt/_DXGKMDT_OPM_PROTECTION_STANDARD
 - DXGKMDT_OPM_PROTECTION_STANDARD
 - d3dkmdt/DXGKMDT_OPM_PROTECTION_STANDARD
topic_type:
 - APIRef
 - kbSyntax
api_type:
